...
import { MainLight, MainBackground, MainMuted, MainHeader } from "../colors";
					...
					<ScrollView style={{
						...
						{gstore.places.map((p, idx) => (
							<TouchableOpacity key={idx}>
								<View style={{ flexDirection: 'row', paddingVertical: 18, paddingHorizontal: 0, backgroundColor: MainBackground, borderBottomColor: '#e0e0e0', borderBottomWidth: 1 }}>
